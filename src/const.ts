...
export const githubReleaseURL = "https://api.github.com/repos/bufbuild/buf/releases/latest";
...
export const bufDocumentSelector = [{ language: "buf", scheme: "file", pattern: "**/buf.yaml" }];
